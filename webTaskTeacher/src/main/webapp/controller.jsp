...
<%
	...
	if(action.equals("main")){
		...
		// 별도로 보내야 하는 데이터가 없기 때문에 response.sendRedirect() 사용중
	}
		...
		// 세션한테 있는 것까지 내가 호출을 못하기 때문에 직접 set으로 보내줌
		// 세션에 있는 값은 object 이기 때문에 호출을 못함. 따라서 String으로 형 변환 후 set 해야함
		...
		if(flag){
			...
			// 회원가입이나 회원정보를 변경했을 경우 로그아웃 상태로 보내줘야 한다. --> location.href='controller.jsp?action=logout
		}
		else{
